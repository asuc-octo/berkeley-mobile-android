...
* Create a new project in the [Google Cloud Console](https://console.cloud.google.com)
  ...
  * Create a local copy of [secret_template.xml](app/src/main/res/values/secret_template.xml) and name it `secret_dev.xml`. Paste your API key in the new file, which should not be tracked by git. Do not modify the template file.
