...
public class HoursStringGenerator {
    ...
    public static Spanned setUpWeeklyHoursLeft(Gym gym) {
        return setUpWeeklyHoursLeft(gym.getWeeklyOpen());
    }

    public static Spanned setUpWeeklyHoursRight(Gym gym, Context context) {
        return setUpWeeklyHoursRight(gym.getWeeklyOpen(), gym.getWeeklyClose(), gym.getWeeklyAppointments(), gym.isOpen(), gym.isByAppointment(), context);
    }
