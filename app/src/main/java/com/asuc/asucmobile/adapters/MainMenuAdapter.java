...
public class MainMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (i % 2 == 0) {
            convertView.setBackground(context.getResources().getDrawable(R.drawable.gray_selector));
        } else {
            convertView.setBackground(context.getResources().getDrawable(R.drawable.white_selector));
        }
